...
<div class="dokan-attribute-variation-options dokan-edit-row dokan-clearfix">
    <div class="dokan-section-heading" data-togglehandler="dokan_attribute_variation_options">
         <h2><i class="fa fa-list-alt" aria-hidden="true"></i> <?php _e( 'الخصائص', 'dokan' ); ?><span class="show_if_variable"><?php _e( ' و السمات', 'dokan' ) ?></span></h2>
        <p class="show_if_variable"><?php _e( 'ادارة خصائص و سمات هذا المنتج', 'dokan' ); ?></p>
        <p class="show_if_simple show_if_grouped"><?php _e( 'ادارة خصائص هذا المنتج البسيط', 'dokan' ); ?></p>
        ...
        <div class="dokan-product-attribute-wrapper show_if_simple show_if_variable show_if_grouped">
            ...
            <div class="dokan-attribute-type">
                <select name="predefined_attribute" id="predefined_attribute" class="dokan-w5 dokan-form-control dokan_attribute_taxonomy" data-predefined_attr='<?php echo json_encode( $attribute_taxonomies ); ?>'>
                    <option value=""><?php _e( 'خصلة محددة', 'dokan' ); ?></option>
                    <?php
                ...
                <a href="#" class="dokan-btn dokan-btn-default add_new_attribute"><?php _e( 'اضافة خصلة', 'dokan' ) ?></a>
                <a href="#" class="dokan-btn dokan-btn-default dokan-btn-theme dokan-save-attribute"><?php _e( 'حفظ الخصلة', 'dokan' ) ?></a>
