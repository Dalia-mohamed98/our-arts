 ...
 */
?>
 <div class="doakn-w12 dashboard-widget dokan-announcement-widget">
    <div class="widget-title">
        <i class="fa fa-bullhorn" aria-hidden="true"></i> <?php _e( 'أحدث الإشعارات', 'dokan' ); ?>

        <span class="pull-right">
            <a href="<?php echo $announcement_url; ?>"><?php _e( 'اظهر الكل', 'dokan' ); ?></a>
        </span>
    </div>
    <?php
    ...
    <?php else: ?>
        <div class="dokan-no-announcement">
            <div class="annoument-no-wrapper">
                ...
                <p><?php _e( 'لا توجد إشعارات', 'dokan' ) ?></p>
            </div>
        </div>
    <?php endif ?>
</div> <!-- .products -->
