...
function dokan_get_order_status_translated( $status ) {
    switch ($status) {
        case 'completed':
        case 'wc-completed':
            return __( 'جاهز للشحن', 'dokan-lite' );
            break;

        case 'pending':
        case 'wc-pending':
            return __( 'بانتظار الدفع', 'dokan-lite' );
            break;

        case 'on-hold':
        case 'wc-on-hold':
            return __( 'بانتظار الموافقة', 'dokan-lite' );
            break;

        case 'processing':
        case 'wc-processing':
            return __( 'بانتظار البوليصة', 'dokan-lite' );
            break;
            
        case 'pickedup':
        case 'wc-pickedup':
            return __( 'مشحون', 'dokan-lite' );
            break;
            
        case 'delivered':
        case 'wc-delivered':
            return __( 'مستلم', 'dokan-lite' );
            break;

        case 'refunded':
        case 'wc-refunded':
            return __( 'مرتجع', 'dokan-lite' );
            break;

        case 'cancelled':
        case 'wc-cancelled':
            return __( 'ملغي', 'dokan-lite' );
            break;

        case 'failed':
        case 'wc-failed':
            return __( 'فشل', 'dokan-lite' );
            break;
